...
let snakeArr = [{ x: 13, y: 15 }]; // Initial position of the snake
...
window.addEventListener("keydown", (e) => {
  inputDir = { x: 0, y: 1 }; // Set initial direction to start the game
  moveSound.play(); // Play move sound on key press
  switch (e.key) {
    case "ArrowUp":
      console.log("ArrowUp");
      inputDir.x = 0;
      inputDir.y = -1; // Change direction to up
      break;

    case "ArrowDown":
      console.log("ArrowDown");
      inputDir.x = 0;
      inputDir.y = 1; // Change direction to down
      break;

    case "ArrowLeft":
      console.log("ArrowLeft");
      inputDir.x = -1; // Change direction to left
      inputDir.y = 0;
      break;

    case "ArrowRight":
      console.log("ArrowRight");
      inputDir.x = 1; // Change direction to right
      inputDir.y = 0;
      break;
    default:
      break;
